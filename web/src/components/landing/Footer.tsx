...
export default function Footer() {
    ...
    return (
        <Box sx={{ bgcolor: '#0B1120', borderTop: '1px solid rgba(212,175,55,0.08)', pt: 8, pb: 4 }}>
            <Container maxWidth="lg">
                <Grid container spacing={6} sx={{ mb: 6 }}>
                    ...
                    <Grid size={{ xs: 12, md: 4 }}>
                        <Stack spacing={2}>
                            ...
                            <Typography sx={{ color: 'rgba(212,175,55,0.4)', fontSize: '0.85rem', lineHeight: 1.7, maxWidth: 300 }}>
                                {t(
                    ...
                    {/* Quick Links */}
                    <Grid size={{ xs: 12, md: 4 }}>
                        <Typography sx={{ color: '#D4AF37', fontWeight: 700, mb: 2 }}>
                            ...
                            {quickLinks.map((link) => (
                                <Typography
                                    ...
                                    sx={{
                                        ...
                                        color: 'rgba(212,175,55,0.4)', fontSize: '0.85rem',
                    ...
                    <Grid size={{ xs: 12, md: 4 }}>
                        ...
                        <Stack spacing={1.5}>
                            <Stack direction="row" alignItems="center" spacing={1}>
                                <EmailIcon sx={{ fontSize: 16, color: 'rgba(212,175,55,0.5)' }} />
                                <Typography sx={{ color: 'rgba(212,175,55,0.4)', fontSize: '0.85rem' }}>
                                    info@egyptlawyers.net
                                </Typography>
                            </Stack>
                            <Stack direction="row" alignItems="center" spacing={1}>
                                <PhoneIcon sx={{ fontSize: 16, color: 'rgba(212,175,55,0.5)' }} />
                                <Typography dir="ltr" sx={{ color: 'rgba(212,175,55,0.4)', fontSize: '0.85rem' }}>
                                    +20 100 000 0000
                                </Typography>
                            </Stack>
                            <Stack direction="row" alignItems="center" spacing={1}>
                                <LocationOnIcon sx={{ fontSize: 16, color: 'rgba(212,175,55,0.5)' }} />
                                <Typography sx={{ color: 'rgba(212,175,55,0.4)', fontSize: '0.85rem' }}>
                ...
                {/* Copyright */}
                <Box sx={{ borderTop: '1px solid rgba(212,175,55,0.08)', pt: 3, textAlign: 'center' }}>
                    <Typography sx={{ color: 'rgba(212,175,55,0.25)', fontSize: '0.75rem' }}>
